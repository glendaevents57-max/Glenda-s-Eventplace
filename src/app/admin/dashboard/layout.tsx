...
export default async function AdminDashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-zinc-100 text-zinc-950 flex flex-col font-sans">
      {/* Sidebar Navigation */}
      <div className="flex flex-grow flex-col md:flex-row">
        <aside className="w-full md:w-64 bg-zinc-100 border-r border-zinc-200 flex flex-col justify-between flex-shrink-0">
          <div>
            {/* Branding */}
            <div className="p-6 border-b border-zinc-200 flex items-center gap-2">
              <Sparkles className="w-5 h-5 text-amber-500" />
              <div className="text-left">
                <div className="font-serif font-bold text-sm tracking-wider uppercase text-zinc-950">
                  Glenda Royale
                </div>
            ...
            <nav className="p-4 space-y-1">
              <Link
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-zinc-650 hover:text-zinc-950 hover:bg-zinc-200/50 transition-all"
              >
          ...
          <div className="p-4 border-t border-zinc-200 space-y-3">
            <div className="px-4 py-2">
              ...
              <div className="text-xs font-bold text-zinc-900 truncate">Kyle Adrianna Sayas</div>
            </div>
